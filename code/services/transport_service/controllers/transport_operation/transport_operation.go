...
func (bc *TransportOperationController) Create(ctx context.Context, transportOperation *pb.TransportOperation) error {
	_, err := bc.dbpool.Exec(ctx, "INSERT INTO transport_operation (type, date, description, transport_id) VALUES ($1, $2, $3, $4)",
		transportOperation.Type, transportOperation.Date.AsTime(), transportOperation.Description, transportOperation.TransportId)
	return err
}
