...
func (bc *RepairWorkController) Create(ctx context.Context, repairWork *pb.RepairWork) error {
	...
	_, err := bc.dbpool.Exec(ctx, "INSERT INTO repair_work (start_time, end_time, transport_id, service_personnel_id, unit_id, description, repair_cost, state) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)",
		fst, fet, repairWork.TransportId, repairWork.ServicePersonnelId, repairWork.UnitId, repairWork.Description, repairWork.RepairCost, repairWork.State)
	return err
}
